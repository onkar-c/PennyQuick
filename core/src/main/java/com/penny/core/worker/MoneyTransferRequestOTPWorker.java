...
public class MoneyTransferRequestOTPWorker extends BaseWorker {

  public MoneyTransferRequestOTPWorker(@NonNull Context context,
  ...
  protected Result executeApi() {
    ...
    return execute(ApiClient.getClient().create(ApiInterface.class)
        .moneyTransferOTP(requestMobileNumerModel));
  }

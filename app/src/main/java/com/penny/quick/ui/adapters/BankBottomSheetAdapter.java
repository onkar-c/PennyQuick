...
public class BankBottomSheetAdapter extends
    RecyclerView.Adapter<BankBottomSheetAdapter.BottomSheetListItemVH> {

  private final List<BankDetails> objectList;
  private final BankBottomSheetListItemClickListener clickListener;

  public BankBottomSheetAdapter(List<BankDetails> objectList,
      BankBottomSheetListItemClickListener clickListener) {
  ...
  public void onBindViewHolder(@NonNull BottomSheetListItemVH holder, int position) {
    BankDetails object = objectList.get(position);
    holder.txtItemName.setText(object.getBankName());
  ...
  public interface BankBottomSheetListItemClickListener {

    void onBottomSheetListItemClick(BankDetails obj);
  }
  ...
  public static class BottomSheetListItemVH extends ViewHolder {
    ...
    public void setDetails(BankDetails object, BankBottomSheetListItemClickListener clickListener) {
